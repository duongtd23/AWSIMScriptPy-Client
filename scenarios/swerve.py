...
def make_swerve_scenario(network,
    ...
    remaining_dis_to_wp1 = np.linalg.norm(wp1 - npc_init_pos) - npc_root_to_frontcenter - speedup_dis
    time_to_wp1 = speedup_time + remaining_dis_to_wp1/npc_speed
    ego_travel_dis = ego_speed * time_to_wp1
    dis_threshold = dx0 + ego_travel_dis + np.linalg.norm(wp1 - npc_init_pos) - npc_root_to_frontcenter
